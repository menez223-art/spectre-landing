...
const COPY = {
  ar: {
    ...
    lead: "نمنحك رابطاً حقيقياً واحداً يعمل 24 ساعة فقط. أدخل بريدك ورقم واتسابك لتصلك طلبات الزبائن عليه.",
  ...
  en: {
    ...
    lead: "We give you one real link that works for 24 hours only. Enter your email and WhatsApp number so your customers' orders reach you.",
    email: "Email address",
    emailPh: "you@example.com",
    ...
    busy: "Creating…",
    cancel: "Cancel",
    terms: "By continuing you accept: one link per email, device and number · it disappears permanently after 24 hours · it cannot be restored or re-created.",
